  ...
  useEffect(() => {
    const fetchBlog = async () => {
      ...
      try {
        ...
        setExistingImage(blog.image as any); // Type cast to any if needed, or update existingImage state type
      } catch (error) {
        console.log(error);
      } finally {
        setLoading(false);
